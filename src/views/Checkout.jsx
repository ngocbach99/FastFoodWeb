  ...
  setPromoCode = (event) => {
    ...
    if (getPromoCode.length > 0) {
      ...
      this.setState({
        ...
        alertMessage: `Mã khuyến mãi giảm ${getPromoCode[0].percentage}% trên tổng giá trị đơn hàng.`,
      });
    } else {
      this.setState({
        showAlert: true,
        alertType: "alert alert-danger",
        alertMessage: "Mã khuyến mãi không được áp dụng cho đơn đặt hàng của bạn",
      });
    }
  };
    ...
    if (this.state.paymentMethod === "creditCard") {
      ...
      chosenPaymentMethod = (
        <div className={"ml-4 p-3"}>
          Bạn sẽ thanh toán khi sản phẩm được giao đến tận tay.
        </div>
      );
    }
        ...
        <div className="row">
          ...
          <div className="col-md-8 order-md-1 ">
            ...
            <form className="shop-form shop-bg-white p-3" noValidate>
              ...
              <h4 className="">Hình thức giao hàng</h4>
              <DeliveryOptions
                currency={this.props.usedCurrencyProp}
